...
export default function Admin() {
  ...
  useEffect(() => {
    ...
    eventSource.onmessage = (event) => {
      ...
      setNotification(`🔔 ¡Actualización en el sistema!`);
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] text-gray-300 p-4 md:p-8 font-sans selection:bg-emerald-500/30">
      <div className="max-w-[90rem] mx-auto">
        ...
        {notification && (
          <div className="fixed top-6 right-6 bg-emerald-500 text-white px-6 py-3 rounded-xl shadow-2xl z-50 animate-bounce flex items-center gap-3 border border-emerald-400">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
              fill="none"
